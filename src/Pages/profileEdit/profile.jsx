        ...
        <div className="row w-100">
          <div
            ...
            <ul className="nav nav-pills flex-column" id="myTab" role="tablist">
              ...
              <li className="nav-item">
                <a
                  className={`nav-link ${activeTab === "yourproperty" ? "active" : ""
                    }`}
          ...
          <div className="col-md-9 py-5" style={{ paddingTop: 50 }}>
            <div className="tab-content" id="myTabContent">
              ...
              <div
                className={`tab-pane fade ${activeTab === "property" ? "show active" : ""
                  }`}
                id="property"
                role="tabpanel"
              ...
              <div
                className={`tab-pane fade ${activeTab === "yourproperty" ? "show active" : ""
                  }`}
                id="property"
                role="tabpanel"
                aria-labelledby="profile-tab"
              ...
              <div
                className={`tab-pane fade ${activeTab === "Ledger" ? "show active" : ""
                  }`}
                id="contact"
                role="tabpanel"
                aria-labelledby="contact-tab"
              ...
              <div
                className={`tab-pane fade ${activeTab === "Tickets" ? "show active" : ""
                  }`}
                id="contact"
                role="tabpanel"
                aria-labelledby="contact-tab"
