...
export const LayoutLandOwnerAgreement = ({ id, tab }) => {
    ...
    const handleAgree = async () => {
        ...
        try {
            const response = await axiosInstance.post("/vendor/layoutsignedagree", payload);
                        ...
                        {ownerData?.status == "signed" ? (null) : (
                            <>
                                ...
                                <div className="text-center">
                                    <button
                                        className="btn_1 btn btn rounded mb-5"
                                        style={{ minWidth: "220px",backgroundColor:"#2f4f4f",color:"white" }}
