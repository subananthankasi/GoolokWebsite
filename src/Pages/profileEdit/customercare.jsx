      ...
      <div className="row w-100">
        ...
        <div className="col-md-9 py-5" style={{ paddingTop: 50 }}>
          ...
          <div className="mb-3 position-relative d-flex">
            ...
            />
          <div class="input-group-append" sty><span class="input-group-text" id="searchIcon"><i class="fas fa-search"></i></span></div>

          </div>

          <div className="row">
            {/* Step 1: Select Topic */}
            <div className="col-md-6 col-lg-4 mt-4 border-end">
            ...
            <div className="col-md-6 col-lg-4 mt-4 border-end">
              ...
              <ul className="list-group">
                ...
                {filteredIssues.length === 0 && <p className="text-muted">No matching results</p>}
              </ul>
            </div>

            {/* Step 3: Get Assistance */}
            <div className="col-md-6 col-lg-4 mt-4">
              <h5>Step 3: Get Assistance</h5>
              {selectedIssue ? (
      ...
      {/* <div className="container profile_edit">
        <div className="row w-100">
          ...
          <div className="col-md-9 py-5" style={{ paddingTop: 50 }}>
            ...
            <div className=" ">
              <div className="row">
                <div className="col-md-4 mt-4 border-end">
                  <h5>Step 1: Select Topic</h5>
                  <ul className="list-group">
                    {faqData.map((item, index) => (
                      <li
                        ...
                        className={`list-group-item d-flex justify-content-between align-items-center ${
                          selectedTopic.topic === item.topic ? "active" : ""
                        }`}
                        onClick={() => {
                          setSelectedTopic(item);
                          setSelectedIssue(null);
                ...
                <div className="col-md-4 mt-4 border-end">
                  <h5>Step 2: Select Issue</h5>
                  <ul className="list-group">
                    {selectedTopic.issues.map((issue, index) => (
                      <li
                        key={index}
                        className={`list-group-item d-flex justify-content-between align-items-center ${
                ...
                <div className="col-md-4 mt-4">
                  ...
                  {selectedIssue ? (
                    <div>
                      {Array.isArray(selectedIssue.answer) ? (
                        <ul style={{ marginLeft: "10px" }}>
                          {selectedIssue.answer.map((point, idx) => (
                            <li style={{ textAlign: "justify" }} key={idx}>
                              {point}
                            </li>
                          ))}
                        </ul>
