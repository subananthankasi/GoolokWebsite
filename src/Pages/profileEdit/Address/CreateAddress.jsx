...
const CreateAddress = () => {
  ...
  return isLoaded ? (
    <>
      ...
      <Dialog visible={visible} style={{ width: '42rem' }} breakpoints={{ '960px': '75vw', '641px': '90vw' }} header="Add Location" modal className="p-fluid" onHide={() => {
        setVisible(false);
        ...
        <div>
          ...
          <div className="mt-3 d-flex justify-content-end ">
            <Button variant="contained" color="success" type="button" onClick={submitLocation}> Submit </Button>
          </div>
        </div>
      </Dialog>
    </>
