  ...
  const steps = [
    {
      ...
      completed: invoiceData[0]?.dpt_status === null ? true : invoiceData[0]?.dpt_status === "Document_verify" ? true : invoiceData[0]?.dpt_status === "Location_verify" ? true : invoiceData[0]?.dpt_status === "Service_verify" ? true : invoiceData[0]?.dpt_status === "Payment_verify" ? true : invoiceData[0]?.dpt_status === "Lawyer_verify" ? true : false
    },
    {
      ...
      completed: invoiceData[0]?.dpt_status === "Document_verify" ? true : invoiceData[0]?.dpt_status === "Location_verify" ? true : invoiceData[0]?.dpt_status === "Service_verify" ? true : invoiceData[0]?.dpt_status === "Payment_verify" ? true : invoiceData[0]?.dpt_status === "Lawyer_verify" ? true : false
    },
    {
      title: "Your Property Location",
      details: (
        <YourPropertyLocation gmapdata={invoiceData[0]?.Gmap} fetchInvoice={fetchInvoice} eid={eid} />
      ),
      completed: invoiceData[0]?.dpt_status === "Location_verify" ? true : invoiceData[0]?.dpt_status === "Document_verify" ? true : invoiceData[0]?.dpt_status === "Service_verify" ? true : invoiceData[0]?.dpt_status === "Payment_verify" ? true : invoiceData[0]?.dpt_status === "Lawyer_verify" ? true : false
    },
    {
      ...
      completed: invoiceData[0]?.dpt_status === "Payment_verify" ? true : invoiceData[0]?.dpt_status === "Lawyer_verify" ? true : false

    },
    {
      title: "Wanted Documents",
      details: (
        <WantedDocuments docData={invoiceData[0]?.Gmap} fetchInvoice={fetchInvoice} eid={eid} />
      ),
    ...
    },
    {
      ...
      details: (
        <LegalOpinionStatus statusData={invoiceData[0]?.opinionStatus} fetchInvoice={fetchInvoice} eid={eid} />
      ),
      completed: invoiceData[0]?.dpt_status === "Lawyer_verify" ? true : false
    },
    {
      title: " Legal Opinion",
      details: (
        <LegalOpinion statusData={invoiceData[0]} fetchInvoice={fetchInvoice} eid={eid} />
      ),
      completed: invoiceData[0]?.dpt_status === "Lawyer_verify" ? true : false
    },
  ];
          ...
          {docData?.map((item, index) => (
            <div className=" " >
              <div className="card" style={{ height: "150px", width: "155px" }}>
                <div className="pdf-wrapper" onClick={() => window.open(`${IMG_PATH}enquiry/${item?.wanted}`, "_blank")}>
                  <embed
  ...
  return (
    ...
    <div className="d-flex justify-content-center p-2">
      <div className="w-80" style={{ width: "30%" }}>
        {statusData?.opinion ? (
          <div className="card" style={{ height: "150px" }}>
            <div className="pdf-wrapper" onClick={() => window.open(`${IMG_PATH}enquiry/lawyer/${statusData?.opinion}`, "_blank")}>
              <embed
