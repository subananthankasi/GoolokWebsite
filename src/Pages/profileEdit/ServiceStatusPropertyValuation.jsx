    ...
    const steps = [
        {
            ...
            completed: invoiceData[0]?.dpt_status === null ? true : invoiceData[0]?.dpt_status === "Document_verify" ? true : invoiceData[0]?.dpt_status === "Location_verify" ? true : invoiceData[0]?.dpt_status === "Service_verify" ? true : invoiceData[0]?.dpt_status === "Payment_verify" ? true : invoiceData[0]?.dpt_status === "hub_verify" ? true : false
        },
        {
            ...
            completed: invoiceData[0]?.dpt_status === "Document_verify" ? true : invoiceData[0]?.dpt_status === "Location_verify" ? true : invoiceData[0]?.dpt_status === "Service_verify" ? true : invoiceData[0]?.dpt_status === "Payment_verify" ? true : invoiceData[0]?.dpt_status === "hub_verify" ? true : false
        },
        {
            ...
            completed: invoiceData[0]?.dpt_status === "Location_verify" ? true : invoiceData[0]?.dpt_status === "Service_verify" ? true : invoiceData[0]?.dpt_status === "Payment_verify" ? true : invoiceData[0]?.dpt_status === "hub_verify" ? true : false
        ...
        },
        {
            ...
            completed: invoiceData[0]?.dpt_status === "Payment_verify" ? true : invoiceData[0]?.dpt_status === "hub_verify" ? true : false

        },
        {
            title: "Schedule For Property valuation",
            details: (
                <ShedulePropertyValuation property={invoiceData[0]} fetchInvoice={fetchInvoice} eid={eid} />
            ),
        ...
        },
        {
            ...
            details: (
                <PropertyValuationReport docData={invoiceData[0]} fetchInvoice={fetchInvoice} eid={eid} />
            ),
            completed: invoiceData[0]?.dpt_status === "hub_verify" ? true : false
        },
    ];
    ...
    return (
        <>
            {property?.confirm?.length === 0 ? (
                ...
                <div className=" p-2">
                    <p className="text-center mt-3"> <b>  Valuation Date Confirmation</b> </p>
                    <hr />
                    <div>
                        <table className="table table-bordered mt-3  table-striped">
                            <thead>
        ...
        <>
...

            {
                docData?.valuation?.length === 0 ? (
                    ...
                    <TabView>
                        <TabPanel header="Property Valuation Report" headerClassName="custom-tab-header">
                            <div className="d-flex " style={{ flexWrap: "wrap", gap: "20px" }}>
                                {docData?.valuation.map((item, index) => (
                                    <div className=" " >
                                        <div className="card" style={{ height: "150px", width: "150px" }}>
