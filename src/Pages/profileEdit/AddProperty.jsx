...
function AddProperty() {
  ...
  const [selectedType, setSelectedType] = useState({ value: "sale", label: "Sale" });
                          ...
                          <div className="row">
                            ...
                            <div className="col-8">
                              ...
                              >
                                ...
                                <option value="get patta for your property"> Get Patta for your property</option>
                                <option value="find your property google map location">Find Your property Google map Location </option>
                              ...
                              <div className="row">
                                ...
                                <div className="col-8">
                                  ...
                                  >
                                    ...
                                    <option value="ANY OTHER DOCUMENTS"> ANY OTHER DOCUMENTS </option>

                                  </select>
                                  {formik.errors.documentlist && formik.touched.documentlist ? (
                                    <p style={{ color: "red", fontSize: "12px" }}>
                              ...
                              >
                                <option>Select.... </option>
                                {
                                  PropertyTypeData?.map((item) => (
                                    <option key={item.id} value={item.id}>{item.property_type} </option>
                                  ))
                                }
                        ...
                        <div className="form-group mt-4">
                          <div className="row">
                            ...
                            <div className="col-8">
                              ...
                              {formik.errors.subproperty && formik.touched.subproperty ? (
                                <p style={{ color: "red", fontSize: "12px" }}>
                          ...
                          <div className="row">
                            ...
                            <div className="col-8">
                              <input
                                ...
                                // onChange={handlePattaFileChange}
                                className="form-control"
                                onBlur={formik.handleBlur}
                              />
                          ...
                          <div className="row">
                            ...
                            <div className="col-8">
                              <input
                                ...
                                accept="application/pdf"
                                onChange={(event) => {
                                  formik.setFieldValue("aadhaar", event.currentTarget.files[0]);
                                }}
                                // onChange={handleAadharFileChange}
                                className="form-control"
                                onBlur={formik.handleBlur}
                              />
                              {formik.errors.aadhaar && formik.touched.aadhaar ? (
                                <p style={{ color: "red", fontSize: "12px" }}>
                          ...
                          <div className="row">
                            ...
                            <div className="col-8">
                              <input
                                ...
                                accept="application/pdf"
                                onChange={(event) => {
                                  formik.setFieldValue("saledeed", event.currentTarget.files[0]);
                                }}
                                // onChange={handleFileChange}
                                className="form-control"
                                onBlur={formik.handleBlur}
                              />
                              {formik.errors.saledeed && formik.touched.saledeed ? (
                                <p style={{ color: "red", fontSize: "12px" }}>
